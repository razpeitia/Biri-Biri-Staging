...
exports.getCommands = (clients) => {
  ...
  new CustomCommand({
    ...
    'execute': (msg) => {
      ...
      if(!items) return msg.channel.send("Necesito algo para elegir, pendejo");
      if (items.length <= 1) return msg.channel.send("Necesito más de un item para elegir, pendejo");
